# Awesome Domain-Driven Design [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 437,720 | 🐛 71 | 📅 2026-01-28 with stars
...
* [Context Mapping by ddd-crew](https://github.com/ddd-crew/context-mapping) ⭐ 1,767 | 🐛 8 | 📅 2025-06-22 - 	Context Mapping Cheatsheet and Starter Kit by ddd-crew.
...
* [DDD by Refactoring](https://github.com/ThreeDotsLabs/wild-workouts-go-ddd-example) ⭐ 6,179 | 🐛 30 | 🌐 Go | 📅 2025-11-03 - Complete serverless application to show how to apply DDD, Clean Architecture, and CQRS by practical refactoring of a Go project. A full blog series about it can be found at <https://threedots.tech/>.
* [Citerus DDD Sample App GO Port](https://github.com/marcusolsson/goddd) ⚠️ Archived - This is an attempt to port the [DDD Sample App](https://github.com/citerus/dddsample-core) ⭐ 5,254 | 🐛 32 | 🌐 Java | 📅 2025-06-02 to idiomatic Go. It can be run in a dockerized mode for previewing the application.
...
* [Modular Monolith](https://github.com/kgrzybek/modular-monolith-with-ddd) ⭐ 13,370 | 🐛 67 | 🌐 C# | 📅 2024-06-04 - Full Modular Monolith .NET application with Domain-Driven Design approach.
...
* [Sample .NET Core CQRS REST API](https://github.com/kgrzybek/sample-dotnet-core-cqrs-api) ⭐ 3,050 | 🐛 14 | 🌐 C# | 📅 2024-02-27 - .NET Core REST API CQRS implementation with raw SQL and DDD using Clean Architecture.
...
* [EventFlow.Example](https://github.com/OKTAYKIR/EventFlow.Example) ⭐ 204 | 🐛 2 | 🌐 C# | 📅 2023-03-03 - DDD, CQRS, and Event-Sourcing example and contains following technology stack: [EventFlow](https://github.com/eventflow/EventFlow) ⭐ 2,539 | 🐛 15 | 🌐 C# | 📅 2025-12-06, [EventStore](https://eventstore.com), [RabbitMQ](https://www.rabbitmq.com), [MongoDB](https://www.mongodb.com), [PostgreSQL](https://www.postgresql.org), [Docker](https://www.docker.com)
...
* [DDD By Examples - Library](https://github.com/ddd-by-examples/library) ⭐ 5,689 | 🐛 23 | 🌐 Java | 📅 2023-07-07 - sample project of a library driven by real business requirements. Modular monolith implemented with the help od DDD, BDD, EventStorming, Example Mapping, CQRS, and more.
* [DDDSample](https://github.com/citerus/dddsample-core) ⭐ 5,254 | 🐛 32 | 🌐 Java | 📅 2025-06-02 - Sample DDD project using Spring Boot (originally hosted in <http://dddsample.sourceforge.net/>)
...
* [GoConvey](https://github.com/smartystreets/goconvey) ⭐ 8,423 | 🐛 167 | 🌐 Go | 📅 2024-07-30 - Go testing in the browser. Integrates with `go test`. Write behavioral tests in Go.
...
* [MassTransit](https://github.com/MassTransit/MassTransit) ⭐ 7,677 | 🐛 4 | 🌐 C# | 📅 2026-02-07 - Distributed Application Framework for .NET.
* [Marten](https://github.com/JasperFx/marten) ⭐ 3,334 | 🐛 30 | 🌐 C# | 📅 2026-02-16 - Postgresql as a Document Database and Event Store for .Net Applications.
* [EventFlow](https://github.com/eventflow/EventFlow) ⭐ 2,539 | 🐛 15 | 🌐 C# | 📅 2025-12-06 - Async/await first CQRS+ES and DDD framework for .NET <http://geteventflow.net/>.
* [NServiceBus](https://github.com/Particular/NServiceBus) ⭐ 2,161 | 🐛 295 | 🌐 C# | 📅 2026-02-12 - Service bus for .NET.
* [NEventStore](https://github.com/NEventStore/NEventStore) ⭐ 1,611 | 🐛 24 | 🌐 C# | 📅 2025-09-26 - A persistence library used to abstract different storage implementations when using event sourcing as storage mechanism.
...
* [CommandQuery](https://github.com/hlaueriksson/CommandQuery) ⭐ 108 | 🐛 2 | 🌐 C# | 📅 2026-01-29 - Command Query Separation for 🌐ASP.NET Core ⚡AWS Lambda ⚡Azure Functions ⚡Google Cloud Functions 🌐ASP.NET Web API 2
...
* [Message DB](https://github.com/message-db/message-db) ⭐ 1,649 | 🐛 24 | 🌐 Shell | 📅 2024-04-13 - Microservice Native Event Store and Message Store for Postgres. A fully-featured event store and message store implemented in PostgreSQL for Pub/Sub, Event Sourcing, Messaging, and Evented Microservices applications.
* [Serialized](https://serialized.io) - Complete platform for Event Sourcing & CQRS.

### Elixir

* [Commanded](https://github.com/slashdotdash/commanded) ⭐ 1,987 | 🐛 26 | 🌐 Elixir | 📅 2026-01-13 - Command handling middleware for CQRS/ES applications, Pure Functional Data Structures for Aggregates and Process Managers, Point-to-Point message routing, and much more in Elixir (Erlang VM) - All in Actor concurrency model.
...
* [Node API Boilerplate](https://github.com/talyssonoc/node-api-boilerplate) ⭐ 3,360 | 🐛 18 | 🌐 TypeScript | 📅 2023-03-04 - NodeJS web API boilerplate for DDD and Clean Architecture applications.
...
* [DDDplus framework](https://github.com/funkygao/cp-ddd-framework) ⭐ 1,156 | 🐛 3 | 🌐 Java | 📅 2025-12-19 - A lightweight flexible development framework for complex business architecture based on DDD.
...
* [Ahoo-Wang/Wow](https://github.com/Ahoo-Wang/Wow) ⭐ 282 | 🐛 13 | 🌐 Kotlin | 📅 2026-02-14 - A Modern Reactive CQRS Architecture Microservice development framework based on DDD and EventSourcing.
